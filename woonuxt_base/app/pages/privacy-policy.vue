<template>
  <main class="container my-8">
    <h1 class="mb-8 text-3xl font-semibold text-primary">Privacy Policy</h1>
    <div class="my-8 prose">
      ...
      <p>
        We collect information you provide during checkout and account registration, including name, email, phone, shipping address, and order details. When you
        contact us, we collect the information you include in your message.
      </p>
      <p>
        If payments are processed via third parties (e.g., Stripe), your payment details are handled securely by the provider and are not stored on our servers.
      </p>
      ...
      <p>
        We retain order and account information for as long as necessary to provide services, comply with legal and tax obligations, and resolve disputes.
      </p>
